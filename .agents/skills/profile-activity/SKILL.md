...
10. Schema v3 snapshots and envelopes contain no source identity. Bind them only to the source slot selected by the installed private config and fixed receiver route; never serialize that binding.

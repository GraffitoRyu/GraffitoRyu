...
test('v3 renderer draws a bounded 30-day token histogram with readable axes', () => {
  ...
  assert.match(svg, /\.panel\{fill:#f6f8fa;fill-opacity:\.02;stroke:#d0d7de\}/);
  assert.match(svg, /\.token-bar\{fill:#0969da;fill-opacity:\.78\}/);
  assert.match(svg, /@media\(prefers-color-scheme:dark\).*\.panel\{fill:#161b22;fill-opacity:\.36;stroke:#30363d\}\.token-bar\{fill:#58a6ff;fill-opacity:\.72\}/);
...
test('verified account activity uses App Server tokens and drives bilingual dashboard copy', async () => {
  ...
  assert.match(english, /fill="#f6f8fa" fill-opacity="\.02"/);

...
<defs><style>text{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;fill:#1f2328}.grid,.divider{stroke:#d0d7de}.panel{fill:#0d1117;fill-opacity:.24;stroke:#d0d7de}@media(prefers-color-scheme:dark){text{fill:#e6edf3}.grid,.divider{stroke:#30363d}.panel{fill-opacity:.96;stroke:#30363d}}</style></defs>
<rect class="panel" x=".5" y=".5" width="899" height="589" rx="12" fill="#0d1117" fill-opacity=".24" stroke="#d0d7de"/>

...
import { atomicWrite, prepareWriteTarget } from './storage.mjs';
...
async function writeGenerated(candidate, generated) {
  if (!generated || Object.keys(generated).sort().join(',') !== [...GENERATED_PATHS].sort().join(',')) throw new Error('invalid generated paths');
